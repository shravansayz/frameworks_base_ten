...
class FaceUnlockIndicatorView @JvmOverloads constructor(
    ...
    fun updateColor() {
        ...
        iconTint = ColorStateList.valueOf(context.getColor(R.color.faceid_title_color))
        backgroundTintList = ColorStateList.valueOf(context.getColor(R.color.faceid_background_color))
    }
