...
public class KeyguardSliceProvider extends SliceProvider implements
    ...
    protected boolean needsMediaLocked() {
        ...
        boolean isCenterMusicTickerEnabled = Settings.Secure.getIntForUser(getContext().getContentResolver(),
                Settings.Secure.AMBIENT_MUSIC_TICKER, 1, UserHandle.USER_CURRENT) == 2;
